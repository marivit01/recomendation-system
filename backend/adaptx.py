...
def adaptX(studentId):
    ...
    # one_hot_path = os.path.abspath("../datos/modelos/model-5/datos-modificados/mate_bajo/one_hot_new_classes_mate_bajo_10085304.csv")
    # one_hot_path = os.path.abspath("../datos/modelos/model-5/datos-modificados/base_datos_bajo/one_hot_new_classes_base_datos_bajo_10085304.csv")
    # one_hot_path = os.path.abspath("../datos/modelos/model-5/datos-modificados/base_datos_bajo/one_hot_new_classes_base_datos_bajo_10085304-1.csv")
    ...
    # one_hot_path = os.path.abspath("../datos/modelos/model-5/datos-modificados/fisica_bajo/one_hot_new_classes_fisica_bajo_10085304-1.csv")
